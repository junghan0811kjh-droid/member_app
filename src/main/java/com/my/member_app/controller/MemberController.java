...
public class MemberController {
    ...
    @PostMapping("/insert")
    // 리다이렉트용 1회성 모델에 담아보내는 기능 : RedirectAttributes
    public String insertMember(@ModelAttribute("dto") MemberDto dto,
        ...
        // 성공 메세지를 RedirectAttributes에 담아 보낸다.
    ...
    public String updateFormView(Model model,
        ...
        // 3. updateDto가 비어있는지 확인 -> member/vies
        if (updateDto == null) {
            redirectAttributes.addFlashAttribute("massage", "선택한 데이터가 없습니다.");
            return "redirect:/member/view";
        } else {
